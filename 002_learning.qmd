...
-   **20% Continuous assessment**: small tests in class and / homework exercises:
...
(Those weights may sligthly be revised as the semester progresses depending on formative assessments).

Marks will compensate each other but achieving a minimum 8/20 in both the R exam and in the Oral exam is necessary in all case for the course to be considered successful. Students who would fail (\<10/20) only one of either R or Oral exam can eventually retake the failed part only in the next semesters, while the mark from the other part is carried over.
