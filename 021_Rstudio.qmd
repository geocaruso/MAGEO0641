...
::: {.callout-note title=""}
Fancy the same colors as mine? I have a modified monokai theme version here: <https://github.com/geocaruso/MAGEO0641/blob/main/data/Misc/Monokai%20SD_mod2025.tmTheme> )
:::
...
- Ask the person sitting to your **left** for his/her name and age. Create an object named after them, using UpperCamelCase and their name and age e.g. `GeoffreyAgeLeft`
