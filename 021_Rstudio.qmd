...
-   Understanding help (necessary arguments and defaulted options)
...
In general, I personnally like files to be all lowercase with underscores and using action verbs to explain what is done in the R file, such as
