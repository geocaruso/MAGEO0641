...
- Interpret the coefficients and global fit
- Test whether there could be a specific effect (downward or upward) of being within any the 3 districts? or of belonging to Canton Luxembourg city vs elsewhere ?

## Examples of multiple linear regressions from various papers

In class discussion including showing how a series of diffrent specifications are usually presented in research papers.
